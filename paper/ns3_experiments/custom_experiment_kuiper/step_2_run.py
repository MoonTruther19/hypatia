...
for num_flows in [1, 2, 4, 8]:
    for tcp in ["TcpCubic"]:
        ...
        commands_to_run.append(
            ...
            f"./ns3 run \"main_satnet --run_dir=../../paper/ns3_experiments/custom_experiment_kuiper/{run_dir}\" "
            f"2>&1 | tee '../../paper/ns3_experiments/custom_experiment_kuiper/{logs_ns3_dir}/console.txt'"
        )
