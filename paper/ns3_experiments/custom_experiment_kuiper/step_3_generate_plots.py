...
def plot(folder, id):
    local_shell.perfect_exec(
        ...
        f"../../../../../../../paper/ns3_experiments/custom_experiment_kuiper/runs/{folder}/logs_ns3 "
        f"../../../../../../../paper/ns3_experiments/custom_experiment_kuiper/data/{folder} "
        f"../../../../../../../paper/ns3_experiments/custom_experiment_kuiper/pdf/{folder} "
